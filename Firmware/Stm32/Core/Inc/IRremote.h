...
#define MYPRESCALER 239//221 // получаем частоту 1МГц
#define MYPERIOD 49    // 50 мкс

// настройка таймера для отправки - указать системную частоту таймера
#define MYSYSCLOCK 240000000//22118400

// настройка пина для приёма recive_IR
#define RECIV_PIN (LL_GPIO_IsInputPinSet(recive_IR_GPIO_Port, recive_IR_Pin))

//#define RECIV_PIN !!(recive_IR_GPIO_Port -> IDR & (1 << recive_IR_Pin))
...
#define SEND_RC5             0 // чтоб отключить отправку сигнала по протоколу RC5 нужно указать 0
