...
#ifndef INC_SI5340_CONF_H_
#define INC_SI5340_CONF_H_
 ...
 * Timestamp:                                          2025-06-30 00:35:52 GMT+03:00
 *
...
si5340_revd_register_t const si5340_revd_registers_98_90[SI5340_REVD_REG_CONFIG_NUM_REGS] =
{
...
si5340_revd_register_t const si5340_revd_registers_90[SI5340_REVD_REG_CONFIG_NUM_REGS] =
{
...
si5340_revd_register_t const si5340_revd_registers_11[SI5340_REVD_REG_CONFIG_NUM_REGS] =
{
...
si5340_revd_register_t const si5340_revd_registers_49[SI5340_REVD_REG_CONFIG_NUM_REGS] =
{
...
si5340_revd_register_t const si5340_revd_registers_22_24Mhz[SI5340_REVD_REG_CONFIG_NUM_REGS] =
{
 ...
 * Includes Pre/Post Download Control Register Writes: Yes
 * Created By:                                         ClockBuilder Pro v4.15.0.2 [2025-05-07]
 * Timestamp:                                          2025-07-14 20:52:29 GMT+03:00
 *
 * A complete design report corresponding to this export is included at the end
 * of this header file.
 *
...
si5340_revd_register_t const si5340_revd_registers44[SI5340_REVD_REG_CONFIG_NUM_REGS] =
{
...
si5340_revd_register_t const si5340_revd_registers48[SI5340_REVD_REG_CONFIG_NUM_REGS] =
{
 ...
 * Design ID:          r2rdac
 * Created By:         ClockBuilder Pro v4.15.0.2 [2025-05-07]
 * Timestamp:          2025-06-30 00:35:51 GMT+03:00
 *
 * Design Rule Check
 * =================
 *
 ...
 * Outputs:
 *    OUT0: 24.576 MHz
 *          Enabled, LVCMOS In-Phase 3.3 V 22 Ω
 *    OUT1: Unused
 *    OUT2: Unused
 *    OUT3: Unused
 *
 ...
 * ----------------------------  -------  -------  ----  ----
 * Typical Ta, Voltage, Current  594 mW   594 mW   25 C  35 C
 *
 *                                    -----------------------
 *                                            Typical
 *                                    -----------------------
 ...
 * VDD                                   1.80       96    172
 * VDDA                                  3.30      113    374
 * VDDO0  OUT0    24.576 MHz  LVCMOS (in-phase)     3.30       14     48
 * VDDO1  OUT1        Unused
 * VDDO2  OUT2        Unused
 * VDDO3  OUT3        Unused
 *                                    -------  -------  -----
 ...
 * 0x0235[43:0]  M_NUM                695784701952       0x0A200000000
 ...
 * 0x0302[43:0]  N0_NUM               579820584960       0x08700000000
