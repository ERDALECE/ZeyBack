...
#define AUDIO_48K_FEEDBACK_VALUE  0x2EE000    // (48000 << 14)
#define AUDIO_44K1_FEEDBACK_VALUE 0x2C6A7F    // (44100 << 14)
...
// NOTE: When adding bRefresh/bSynchAddress (endpoint bLength 9), total size increases.
// This value MUST match the number of bytes in USBD_AUDIO_CfgDesc[] (audio_desc.c).
#define USB_AUDIO_CONFIG_DESC_SIZE                    152U
...
// Current stream valid bits (24 or 32). Updated on SET_INTERFACE.
