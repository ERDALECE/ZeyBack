 ...
 *
 * This file represents a series of Skyworks Si5340 Rev D 
 ...
 * Timestamp:                                          2025-12-30 10:08:32 GMT+03:00
 *
...
si5340_revd_register_t const si5340_bclk_22_5792[SI5340_REVD_REG_CONFIG_NUM_REGS] =
{
		 ...
		 *
		 * Part:               Si5340AB Rev D
		 * Project File:       C:\Users\Erdalpc\Desktop\Si5340-RevD-r2rdac-Project.slabtimeproj
		 * Design ID:          r2rdac
		 * Created By:         ClockBuilder Pro v4.15.0.2 [2025-05-07]
		 * Timestamp:          2026-04-06 00:55:42 GMT+03:00
		 *
		 * Design Rule Check
		 * =================
		 *
		 ...
		 *
		 * Warnings:
		 * - Incompatible XTAL frequency 25 MHz [1]
		 * - N1: jitter may be higher on than expected on OUT0 due to DCO range greater
		 *   than 350 ppm. Consider lower DCO range or contact Skyworks if lowest jitter
		 *   is required.
		 *
		 * Notes:
		 ...
		 *
		 * Footnotes:
		 * [1] For optimal jitter and phase noise performance, Skyworks requires the use of 48 to 54 MHz XTALs compliant with the specifications noted in the Si534x/7x/8x/9x Family Reference Manuals.  Using XTAL frequencies other than these may be possible, but jitter and phase noise performance may be degraded. Contact Skyworks to determine the impacts on your configuration.
		 *
		 * Device Grade
		 * ============
		 ...
		 *       OUT3: 50 MHz
		 *    N1:
		 *       Value: 13.9192581794622610... [ 13 + 11351/12348 ]
		 *       OUT0: 22.5792 MHz
		 *    N2:
		 *       Unused
		 *    N3:
		 ...
		 *    N1_FSTEPW:          45056
		 *
		 *    Desired Step Size:  1 ppm
		 *    Actual Step Size:   1.000001000001... ppm
		 *    Range:              900 ppm
		 *
		 *    OUT0
		 *         R0:            42
		 *         Initial Freq:  22.5792 MHz
		 *         Step Size:     22.579222579222... Hz
		 *         Min Freq:      22.558919531341... MHz
		 *         Max Freq:      22.599516965752... MHz
		 *
		 * N2: DCO Disabled
		 *
		 * N3: DCO Disabled
		 ...
		 * ----------------------------  -------  -------  ----  ----
		 * Typical Ta, Voltage, Current  806 mW   806 mW   25 C  39 C
		 *
		 *                                     -----------------------
		 *                                             Typical
		 *                                     -----------------------
		 ...
		 * VDD                                    1.80      136    245
		 * VDDA                                   3.30      115    379
		 * VDDO0  OUT0    22.5792 MHz  LVCMOS (in-phase)     1.80       14     25
		 * VDDO1  OUT1         50 MHz  LVCMOS (in-phase)     3.30       16     52
		 * VDDO2  OUT2         50 MHz  LVCMOS (in-phase)     3.30       16     52
		 * VDDO3  OUT3         50 MHz  LVCMOS (in-phase)     3.30       16     52
		 *                                     -------  -------  -----
		 *                                        1.80      150    270
		 *                                        3.30      162    536
		 *                                     -------  -------  -----
		 ...
		 * 0x0235[43:0]  M_NUM                1133871366144      0x10800000000
		 * 0x023B[31:0]  M_DEN                2147483648         0x80000000
		 * 0x0250[23:0]  R0_REG               20                 0x000014
		 * 0x0253[23:0]  R1_REG               0                  0x000000
		 * 0x025C[23:0]  R2_REG               0                  0x000000
		 * 0x025F[23:0]  R3_REG               0                  0x000000
		 * 0x026B[7:0]   DESIGN_ID0           114                0x72
		 * 0x026C[7:0]   DESIGN_ID1           50                 0x32
		 * 0x026D[7:0]   DESIGN_ID2           114                0x72
		 * 0x026E[7:0]   DESIGN_ID3           100                0x64
		 * 0x026F[7:0]   DESIGN_ID4           97                 0x61
		 * 0x0270[7:0]   DESIGN_ID5           99                 0x63
		 * 0x0271[7:0]   DESIGN_ID6           0                  0x00
		 * 0x0272[7:0]   DESIGN_ID7           0                  0x00
		 * 0x0302[43:0]  N0_NUM               283467841536       0x04200000000
		 * 0x0308[31:0]  N0_DEN               2147483648         0x80000000
		 * 0x030C[0]     N0_UPDATE            0                  0x0
		 * 0x030D[43:0]  N1_NUM               45056000000        0x00A7D8C0000
		 * 0x0313[31:0]  N1_DEN               3236954112         0xC0F00000
		 ...
		 * 0x0339[4:0]   N_FSTEP_MSK          29                 0x1D
		 * 0x033B[43:0]  N0_FSTEPW            0                  0x00000000000
		 * 0x0341[43:0]  N1_FSTEPW            45056              0x0000000B000
